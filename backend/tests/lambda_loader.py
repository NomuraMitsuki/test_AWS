...
health / attendance / leave / users がいずれも `handler.py` を持つため、PYTHONPATH を
...
_LAMBDA_DIRS = ("health", "attendance", "leave", "users")
_LAMBDA_MODULES = ("handler", "auth", "service", "repository", "errors", "cognito")
